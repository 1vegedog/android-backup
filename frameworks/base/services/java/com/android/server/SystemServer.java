...
public final class SystemServer {
    ...
    private void startOtherServices(@NonNull TimingsTraceAndSlog t) {
        ...
        try {
            ...
            //add code by dtl
            t.traceBegin("StartMirrorMediaService");
	    try{
            mSystemServiceManager.startService(com.android.server.mirror.MirrorMediaService.class);
	   } catch (Throwable exMirror) {Slog.e(TAG, "Failed to start MirrorMediaService, skipping", exMirror); }
	   t.traceEnd();
