...
public final class SystemServiceRegistry {
    ...
    static {
        ...
        // add code by DTL
	registerService(Context.MIRROR_MEDIA_SERVICE, MirrorMediaManager.class,
                new CachedServiceFetcher<MirrorMediaManager>() {
            @Override
            public MirrorMediaManager createService(ContextImpl ctx) throws ServiceNotFoundException {
                IBinder b = ServiceManager.waitForService(Context.MIRROR_MEDIA_SERVICE);
                return new MirrorMediaManager(b);
            }});
